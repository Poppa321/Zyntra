...
// The real four-color "G" mark, not a flat monochrome stand-in — this is the
// one place brand rules relax, since Google's own mark must render in its
// own colors to stay recognizable and trustworthy as a sign-in affordance.
